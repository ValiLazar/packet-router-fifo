...
**Key Observations:**
* **Routing:** When the input address is `11` (binary), the payload is directed to `device3`.
* **Flow Control:** The `ready_o` signal remains high as long as the FIFO is not full, allowing continuous data ingestion.
